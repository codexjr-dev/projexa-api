...
describe("@Project", () => {
  ...
  describe("POST /project", () => {
    ...
    // tá voltando 500 quando devia ser 201. Aparentemente em auth.ts todo erro de autenticação retorna 500
    it("Cria um projeto mas dessa vez com autenticação", async () => {
      const response = await request
        .execute(server)
        .post("/project")
